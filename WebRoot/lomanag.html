...
<div class="formbody">
    ...
    <li><a href="#tab3" class="selected">用户日志管理</a></li> 
    <li><a href="#tab4">设备状态日志</a></li> 
  	</ul>
    </div> 
      ...
      <li>
         ...
         <li>
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
             <tr>
               <td width="85">&nbsp;</td>
               <td height="50"><input name="input2" type="button" class="scbtn" value="查询"/>
                 　
                 <input name="input3" type="button" class="scbtn" value="重置"/>
                 　
                 <input name="input6" type="button" class="scbtn" value="删除"/></td>
             </tr>
  </table>
</li>
