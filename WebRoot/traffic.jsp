...
<div class="formbody" >
     ...
     <div class="tabson" style="margin-top:0px;" ><ul class="toolbar" style="width:100%; margin-bottom:10px;"><li style="padding-left:5px;">信号机基本信息 |　IP:192.168.1.27　地址:人民中路十字路口　名称:人民路信号灯　</li></ul>
       <div style="width:100%; float:left;">
         ...
         <div style="width: 29px; float:left; height: 29px; margin-left: 195px;"><img alt="东西方向人行道" class="l03" src="images/rod/l030.png" width="29" height="29" /></div>
         <div style=" float:left; width: 29px; height: 29px; margin-left: 305px;"><img alt="东西方向人行道" class="l03" src="images/rod/l030.png" width="29" height="29" /></div>
         </li>
           <li style="height:29px;">
             <div style="width: 29px; float:left;  margin-top: 0px; height: 29px; margin-left: 150px;"><img class="l13" alt="南北方向人行道" src="images/rod/l030.png" width="29" height="29" /></div>
             <div style="width: 29px; float:left;  margin-top: 0px; height: 29px; margin-left: 390px;"><img class="l13" alt="南北方向人行道" src="images/rod/l030.png" width="29" height="29" /></div>
           </li>
           <li style="height: 270px;">
             <div style="height: 270px; width: 100%; float: left;">
               <div style="width: 33px; height: 96px; float: left; margin-top: 160px; margin-left: 205px; overflow: hidden; background: url(images/rod/trabg1.png ) no-repeat center;">
               ...
               <div style="width: 33px; height: 96px; float: left; margin-top: 25px; margin-left: 10px; overflow: hidden; background: url(images/rod/trabg1.png ) no-repeat center;">
                 <table width="33" border="0" cellspacing="0" cellpadding="0">
                   <tr>
                     <td height="8"></td>
                   </tr>
           ...
           <li style="height:29px;">
             <div style="width: 29px; height: 29px; float:left; margin-left: 150px;"><img class="l13"  src="images/rod/l030.png" alt="南北人行道" width="29" height="29" /></div>
             <div style="width: 29px; float:left;  margin-top: 0px; height: 29px; margin-left: 390px;"><img class="l13" src="images/rod/l030.png" alt="南北人行道" width="29" height="29" /></div>
           </li>
           <ul>
             <li style="height:29px;">
               <div style="width: 29px; height: 29px; float:left; margin-left: 195px;"><img class="l03" src="images/rod/l030.png" alt="东西人行道" width="29" height="29" /></div>
               <div style=" float:left; width: 29px; height: 29px; margin-left: 305px;"><img class="l03" src="images/rod/l030.png" alt="东西人行道" width="29" height="29" /></div>
             </li>
           </ul>
         </div>
       </div>
...
<p>故障信息：</p>
 <div style="width:240px; height:100px; overflow:auto;"><cite>该信号灯运行正常，无故障。如果是请点击确定按钮 ，否则请点取消。该信号灯运行正常，无故障。如果是请点击确定按钮 ，否则请点取消。该信号灯运行正常，无故障。如果是请点击确定按钮 ，否则请点取消。该信号灯运行正常，无故障。如果是请点击确定按钮 ，否则请点取消。该信号灯运行正常，无故障。如果是请点击确定按钮 ，否则请点取消。该信号灯运行正常，无故障。如果是请点击确定按钮 ，否则请点取消。</cite></div>
  ...
  <tr>
    <td>服务器：</td>
    <td><select name="select" class="select2">
              <option>118信号服务器</option>
              <option>125信号服务器</option>
              <option>006信号服务器</option>
            </select></td>
  </tr>
</table>
...
<p><btn class="forminfobtn">查 询</btn></p>
        </div>
     </div>
