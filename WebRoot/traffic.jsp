...
<div class="formbody" >
     ...
     <div class="tabson" style="margin-top:0px;" ><ul class="toolbar" style="width:100%; margin-bottom:10px;"><li style="padding-left:5px;">信号机基本信息 |　IP:<s:property value="sig.ip"/>&nbsp;&nbsp;&nbsp;地址:<s:property value="sig.address"/>&nbsp;&nbsp;&nbsp;名称:<s:property value="sig.name" />　</li></ul>
       <div style="width:100%; float:left;">
         ...
         <div style="width: 29px; float:left; height: 29px; margin-left: 195px;"><img alt="东西方向人行道西面上面" class="l03" src="images/rod/l031.png" width="29" height="29" /></div>
         <div style=" float:left; width: 29px; height: 29px; margin-left: 305px;"><img alt="东西方向人行道东面上面" class="l03" src="images/rod/l031.png" width="29" height="29" /></div>
           ...
           <li style="height:29px;">
             <div style="width: 29px; float:left;  margin-top: 0px; height: 29px; margin-left: 150px;"><img class="l13" alt="南北方向人行道北面右边" src="images/rod/l130.png" width="29" height="29" /></div>
             <div style="width: 29px; float:left;  margin-top: 0px; height: 29px; margin-left: 390px;"><img class="l13" alt="南北方向人行道北面左边" src="images/rod/l130.png" width="29" height="29" /></div>
           </li>
           ...
           <ul>
             <li style="height:29px;">
               ...
               <img class="l03" src="images/rod/l030.png" alt="东西人行道西面下边" width="29" height="29" /></div>
